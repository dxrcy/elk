...
fn emulate(
    ...
    const conn_write_buffer_size = 1024;
    const conn_read_buffer_size = 1024;

    var conn_write_buffer: [conn_write_buffer_size]u8 = undefined;
    var conn_read_buffer: [conn_read_buffer_size]u8 = undefined;
