...
pub fn tryInteger(string: []const u8) Error!?Word {
    ...
    var form: Form = .{
        ...
        .zero = prefix.zero,
        .delimited = false,
        .prefix_length = string.len - chars.string.len,
    };
...
test tryInteger {
    ...
    const cases = [_]struct {
        ...
        .{ "-0", .{ .underlying = 0, .form = .{ .radix = null, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 0 } } },
        .{ "#0", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "#00", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "-#0", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+#0", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+#00", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#-0", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#+0", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .positive, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#-00", .{ .underlying = 0, .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "4", .{ .underlying = 4, .form = .{ .radix = null, .sign = null, .zero = false, .delimited = false, .prefix_length = 0 } } },
        .{ "+4", .{ .underlying = 4, .form = .{ .radix = null, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "4284", .{ .underlying = 4284, .form = .{ .radix = null, .sign = null, .zero = false, .delimited = false, .prefix_length = 0 } } },
        .{ "004_2_84", .{ .underlying = 4284, .form = .{ .radix = null, .sign = null, .zero = true, .delimited = true, .prefix_length = 1 } } },
        .{ "#4", .{ .underlying = 4, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "#4284", .{ .underlying = 4284, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "#0_04284", .{ .underlying = 4284, .form = .{ .radix = .decimal, .sign = null, .zero = false, .delimited = true, .prefix_length = 1 } } },
        .{ "-4", .{ .underlying = cast(-4), .form = .{ .radix = null, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "-4284", .{ .underlying = cast(-4284), .form = .{ .radix = null, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "-004284", .{ .underlying = cast(-4284), .form = .{ .radix = null, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "-#4", .{ .underlying = cast(-4), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+#4", .{ .underlying = 4, .form = .{ .radix = .decimal, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "-#4284", .{ .underlying = cast(-4284), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "-#004284", .{ .underlying = cast(-4284), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#-4", .{ .underlying = cast(-4), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#+4", .{ .underlying = 4, .form = .{ .radix = .decimal, .sign = .{ .value = .positive, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#-4284", .{ .underlying = cast(-4284), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "#-004284", .{ .underlying = cast(-4284), .form = .{ .radix = .decimal, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        // Hex
        .{ "x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "0x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = null, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "x00", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "0x00", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = null, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "-x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "-0x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "+x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+0x0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "+x00", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+0x00", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "x-0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "0x-0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "x+0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "0x+0", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .post_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "x-00", .{ .underlying = 0x0, .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "x4", .{ .underlying = 0x4, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "x4ac", .{ .underlying = 0x4ac, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "x004_ac", .{ .underlying = 0x4ac, .form = .{ .radix = .hex, .sign = null, .zero = false, .delimited = true, .prefix_length = 1 } } },
        .{ "0x004ac", .{ .underlying = 0x4ac, .form = .{ .radix = .hex, .sign = null, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "-x4", .{ .underlying = cast(-0x4), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+x4", .{ .underlying = 0x4, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "-x4ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "-0x4ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "-x0_04a_c", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = true, .prefix_length = 2 } } },
        .{ "-0x004ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "x-4", .{ .underlying = cast(-0x4), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "x+4", .{ .underlying = 0x4, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "0x+4", .{ .underlying = 0x4, .form = .{ .radix = .hex, .sign = .{ .value = .positive, .position = .post_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "x-4ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "x-004ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "0x-004ac", .{ .underlying = cast(-0x4ac), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .post_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        // Octal, binary
        .{ "o0", .{ .underlying = 0o0, .form = .{ .radix = .octal, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "0o77", .{ .underlying = 0o77, .form = .{ .radix = .octal, .sign = null, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "-o077", .{ .underlying = cast(-0o77), .form = .{ .radix = .octal, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+0o77", .{ .underlying = 0o77, .form = .{ .radix = .octal, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "b0", .{ .underlying = 0b0, .form = .{ .radix = .binary, .sign = null, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "0b101", .{ .underlying = 0b101, .form = .{ .radix = .binary, .sign = null, .zero = true, .delimited = false, .prefix_length = 2 } } },
        .{ "-b0101", .{ .underlying = cast(-0b101), .form = .{ .radix = .binary, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 2 } } },
        .{ "+0b10_1", .{ .underlying = 0b101, .form = .{ .radix = .binary, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = true, .delimited = true, .prefix_length = 3 } } },
        // Characters
        ...
        .{ "+65535", .{ .underlying = 0xffff, .form = .{ .radix = null, .sign = .{ .value = .positive, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 1 } } },
        .{ "0x10000", error.IntegerTooLarge },
        .{ "65536", error.IntegerTooLarge },
        .{ "-0x8000", .{ .underlying = cast(-0x8000), .form = .{ .radix = .hex, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = true, .delimited = false, .prefix_length = 3 } } },
        .{ "-32768", .{ .underlying = cast(-0x8000), .form = .{ .radix = null, .sign = .{ .value = .negative, .position = .pre_radix }, .zero = false, .delimited = false, .prefix_length = 1 } } },
